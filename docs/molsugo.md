...
> **例（4人プレイ、手番順A→B→C→D）**: Cが終了宣言した場合、Dまで手番を行ってから終了。BやCが終了宣言した場合は同様にDまで。Aが終了宣言した場合はB・C・Dの手番が終わったら終了。
...
3. 全員が選び終わったら **掛け声とともに同時に表向き**
   > 掛け声は何でも自由。「いっせいのせい」「レディーファイト！」「３・２・１・０」「せーの」など、テーブルで好きなものを使ってください。
